...
[![travis](https://travis-ci.org/jcubic/jquery.terminal.svg?branch=master&dc27a6b962c0f382aab917230ad953be311d3bdf)](https://travis-ci.org/jcubic/jquery.terminal)
...
Then include js/jquery.terminal-2.17.1.min.js and css/jquery.terminal-2.17.1.min.css

You can grab the files from CDN:

```html
<script src="https://cdnjs.cloudflare.com/ajax/libs/jquery.terminal/2.17.1/js/jquery.terminal.min.js"></script>
<link href="https://cdnjs.cloudflare.com/ajax/libs/jquery.terminal/2.17.1/css/jquery.terminal.min.css" rel="stylesheet"/>
```

or

```html
<script src="https://cdn.jsdelivr.net/npm/jquery.terminal@2.17.1/js/jquery.terminal.min.js"></script>
<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/jquery.terminal@2.17.1/css/jquery.terminal.min.css">
```
