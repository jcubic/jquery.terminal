<h1 align="center">
  <img src="https://github.com/jcubic/jquery.terminal/blob/master/assets/ascii_art.svg?raw=true&ver=2.40.3"
...
[![npm](https://img.shields.io/badge/npm-2.40.3-blue.svg)](https://www.npmjs.com/package/jquery.terminal)
![bower](https://img.shields.io/badge/bower-2.40.3-yellow.svg)
...
* [https://jcubic.github.io/jquery.terminal/?ver=2.40.3](https://jcubic.github.io/jquery.terminal/?ver=2.40.3)
...
```html
<script src="https://cdn.jsdelivr.net/npm/jquery.terminal@2.40.3/js/jquery.terminal.min.js"></script>
<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/jquery.terminal@2.40.3/css/jquery.terminal.min.css"/>
```
