...
[![npm](https://img.shields.io/badge/npm-2.4.0-blue.svg)](https://www.npmjs.com/package/jquery.terminal)
![bower](https://img.shields.io/badge/bower-2.4.0-yellow.svg)
[![travis](https://travis-ci.org/jcubic/jquery.terminal.svg?branch=master&fb19f671546993b1b886652518d3306e926f74cd)](https://travis-ci.org/jcubic/jquery.terminal)
[![Coverage Status](https://coveralls.io/repos/github/jcubic/jquery.terminal/badge.svg?branch=master&03d8e77a2e811736676f554817939fb1)](https://coveralls.io/github/jcubic/jquery.terminal?branch=master)
...
Then include js/jquery.terminal-2.4.0.min.js and css/jquery.terminal-2.4.0.min.css

You can grab the files from CDN:

```html
<script src="https://cdnjs.cloudflare.com/ajax/libs/jquery.terminal/2.4.0/js/jquery.terminal.min.js"></script>
...
```html
<script src="https://cdn.jsdelivr.net/npm/jquery.terminal@2.4.0/js/jquery.terminal.min.js"></script>
<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/jquery.terminal@2.4.0/css/jquery.terminal.min.css">
```
