...
[![npm](https://img.shields.io/badge/npm-1.11.4-blue.svg)](https://www.npmjs.com/package/jquery.terminal)
![bower](https://img.shields.io/badge/bower-1.11.4-yellow.svg)
...
Then include js/jquery.terminal-1.11.4.min.js and css/jquery.terminal-1.11.4.min.css
...
```html
<script src="https://cdn.jsdelivr.net/npm/jquery.terminal@1.11.4/js/jquery.terminal.min.js"></script>
<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/jquery.terminal@1.11.4/css/jquery.terminal.min.css">
```
