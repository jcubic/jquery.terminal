...
[![npm](https://img.shields.io/badge/npm-1.7.1-blue.svg)](https://www.npmjs.com/package/jquery.terminal)
...
Then include js/jquery.terminal-1.7.1.min.js and css/jquery.terminal-1.7.1.css

```html
<script src="js/jquery.terminal-1.7.1.min.js"></script>
<link href="css/jquery.terminal-1.7.1.css" rel="stylesheet"/>
```
...
```html
<script src="https://cdnjs.cloudflare.com/ajax/libs/jquery.terminal/1.7.1/js/jquery.terminal.min.js"></script>
<link href="https://cdnjs.cloudflare.com/ajax/libs/jquery.terminal/1.7.1/css/jquery.terminal.min.css" rel="stylesheet"/>
```

or

```html
<script src="https://cdn.jsdelivr.net/npm/jquery.terminal@1.7.1/js/jquery.terminal.min.js"></script>
<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/jquery.terminal@1.7.1/css/jquery.terminal.min.css">
```
