...
[![npm](https://img.shields.io/badge/npm-1.5.0-blue.svg)](https://www.npmjs.com/package/jquery.terminal)
...
Then include js/jquery.terminal-1.5.0.min.js and css/jquery.terminal-1.5.0.css

```html
<script src="js/jquery.terminal-1.5.0.min.js"></script>
<link href="css/jquery.terminal-1.5.0.css" rel="stylesheet"/>
```
...
```html
<script src="https://cdn.jsdelivr.net/jquery.terminal/1.5.0/jquery.terminal.min.js"></script>
<link rel="stylesheet" href="https://cdn.jsdelivr.net/jquery.terminal/1.5.0/jquery.terminal.min.css">
```
