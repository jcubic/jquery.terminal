...
[![travis](https://travis-ci.org/jcubic/jquery.terminal.svg?branch=master&6f8b21583403144591919690e5dd5cfeb7c2be85)](https://travis-ci.org/jcubic/jquery.terminal)
...
Then include js/jquery.terminal-2.20.2.min.js and css/jquery.terminal-2.20.2.min.css

You can grab the files from CDN:

```html
<script src="https://cdnjs.cloudflare.com/ajax/libs/jquery.terminal/2.20.2/js/jquery.terminal.min.js"></script>
<link href="https://cdnjs.cloudflare.com/ajax/libs/jquery.terminal/2.20.2/css/jquery.terminal.min.css" rel="stylesheet"/>
```

or

```html
<script src="https://cdn.jsdelivr.net/npm/jquery.terminal@2.20.2/js/jquery.terminal.min.js"></script>
