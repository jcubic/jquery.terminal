...
[![npm](https://img.shields.io/badge/npm-1.22.7-blue.svg)](https://www.npmjs.com/package/jquery.terminal)
![bower](https://img.shields.io/badge/bower-1.22.7-yellow.svg)
[![travis](https://travis-ci.org/jcubic/jquery.terminal.svg?branch=master&6bc03223b063bf219bc564f7f6049bb622df4117)](https://travis-ci.org/jcubic/jquery.terminal)
...
Then include js/jquery.terminal-1.22.7.min.js and css/jquery.terminal-1.22.7.min.css
...
```html
<script src="https://cdn.jsdelivr.net/npm/jquery.terminal@1.22.7/js/jquery.terminal.min.js"></script>
<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/jquery.terminal@1.22.7/css/jquery.terminal.min.css">
```
