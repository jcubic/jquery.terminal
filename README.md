...
[![npm](https://img.shields.io/badge/npm-2.32.0-blue.svg)](https://www.npmjs.com/package/jquery.terminal)
![bower](https://img.shields.io/badge/bower-2.32.0-yellow.svg)
...
[![Coverage Status](https://coveralls.io/repos/github/jcubic/jquery.terminal/badge.svg?branch=master&9c150782f1397f5a0068d0697c13563d)](https://coveralls.io/github/jcubic/jquery.terminal?branch=master)
...
* [https://jcubic.github.io/jquery.terminal/?ver=2.32.0](https://jcubic.github.io/jquery.terminal/?ver=2.32.0)
...
Then include js/jquery.terminal-2.32.0.min.js and css/jquery.terminal-2.32.0.min.css

You can grab the files from CDN:

```html
<script src="https://cdnjs.cloudflare.com/ajax/libs/jquery.terminal/2.32.0/js/jquery.terminal.min.js"></script>
<link href="https://cdnjs.cloudflare.com/ajax/libs/jquery.terminal/2.32.0/css/jquery.terminal.min.css" rel="stylesheet"/>
```
...
<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/jquery.terminal@2.32.0/css/jquery.terminal.min.css">
```
