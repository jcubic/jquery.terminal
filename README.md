...
[![npm](https://img.shields.io/badge/npm-1.6.4-blue.svg)](https://www.npmjs.com/package/jquery.terminal)
![bower](https://img.shields.io/badge/bower-1.6.4-yellow.svg)
...
Then include js/jquery.terminal-1.6.4.min.js and css/jquery.terminal-1.6.4.css

```html
<script src="js/jquery.terminal-1.6.4.min.js"></script>
<link href="css/jquery.terminal-1.6.4.css" rel="stylesheet"/>
```
...
```html
<script src="https://cdn.jsdelivr.net/jquery.terminal/1.6.4/jquery.terminal.min.js"></script>
<link rel="stylesheet" href="https://cdn.jsdelivr.net/jquery.terminal/1.6.4/jquery.terminal.min.css">
```
