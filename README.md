...
[![npm](https://img.shields.io/badge/npm-2.17.5-blue.svg)](https://www.npmjs.com/package/jquery.terminal)
![bower](https://img.shields.io/badge/bower-2.17.5-yellow.svg)
[![travis](https://travis-ci.org/jcubic/jquery.terminal.svg?branch=master&3000a4b5aab4d4f8a953296403d7ad5f963269d3)](https://travis-ci.org/jcubic/jquery.terminal)
...
```html
<script src="https://cdnjs.cloudflare.com/ajax/libs/jquery.terminal/2.17.5/js/jquery.terminal.min.js"></script>
<link href="https://cdnjs.cloudflare.com/ajax/libs/jquery.terminal/2.17.5/css/jquery.terminal.min.css" rel="stylesheet"/>
```

or

```html
<script src="https://cdn.jsdelivr.net/npm/jquery.terminal@2.17.5/js/jquery.terminal.min.js"></script>
<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/jquery.terminal@2.17.5/css/jquery.terminal.min.css">
```
