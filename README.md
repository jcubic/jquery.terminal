...
[![npm](https://img.shields.io/badge/npm-1.15.0-blue.svg)](https://www.npmjs.com/package/jquery.terminal)
![bower](https://img.shields.io/badge/bower-1.15.0-yellow.svg)
[![travis](https://travis-ci.org/jcubic/jquery.terminal.svg?branch=master&5d6f3e87705eefe314f78718b377691901622c11)](https://travis-ci.org/jcubic/jquery.terminal)
[![Coverage Status](https://coveralls.io/repos/github/jcubic/jquery.terminal/badge.svg?branch=master&0ee13e8366bc9538ed96c5af3d14da17)](https://coveralls.io/github/jcubic/jquery.terminal?branch=master)
...
Then include js/jquery.terminal-1.15.0.min.js and css/jquery.terminal-1.15.0.min.css
...
```html
<script src="https://cdn.jsdelivr.net/npm/jquery.terminal@1.15.0/js/jquery.terminal.min.js"></script>
<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/jquery.terminal@1.15.0/css/jquery.terminal.min.css">
```
