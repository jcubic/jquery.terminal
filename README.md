...
[![npm](https://img.shields.io/badge/npm-1.19.1-blue.svg)](https://www.npmjs.com/package/jquery.terminal)
![bower](https://img.shields.io/badge/bower-1.19.1-yellow.svg)
[![travis](https://travis-ci.org/jcubic/jquery.terminal.svg?branch=master&84c8de63d9ff20444609c3c6be2c44c2ed45fa33)](https://travis-ci.org/jcubic/jquery.terminal)
[![Coverage Status](https://coveralls.io/repos/github/jcubic/jquery.terminal/badge.svg?branch=master&a2c93c501958342625dd97d3ae232d73)](https://coveralls.io/github/jcubic/jquery.terminal?branch=master)
...
Then include js/jquery.terminal-1.19.1.min.js and css/jquery.terminal-1.19.1.min.css
...
```html
<script src="https://cdn.jsdelivr.net/npm/jquery.terminal@1.19.1/js/jquery.terminal.min.js"></script>
<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/jquery.terminal@1.19.1/css/jquery.terminal.min.css">
```
