...
[![npm](https://img.shields.io/badge/npm-2.30.0-blue.svg)](https://www.npmjs.com/package/jquery.terminal)
![bower](https://img.shields.io/badge/bower-2.30.0-yellow.svg)
...
* [https://jcubic.github.io/jquery.terminal/?ver=2.30.0](https://jcubic.github.io/jquery.terminal/?ver=2.30.0)
...
Then include js/jquery.terminal-2.30.0.min.js and css/jquery.terminal-2.30.0.min.css

You can grab the files from CDN:

```html
<script src="https://cdnjs.cloudflare.com/ajax/libs/jquery.terminal/2.30.0/js/jquery.terminal.min.js"></script>
<link href="https://cdnjs.cloudflare.com/ajax/libs/jquery.terminal/2.30.0/css/jquery.terminal.min.css" rel="stylesheet"/>
```

or

```html
<script src="https://cdn.jsdelivr.net/npm/jquery.terminal@2.30.0/js/jquery.terminal.min.js"></script>
<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/jquery.terminal@2.30.0/css/jquery.terminal.min.css">
```
