...
Include js/jquery.terminal-0.10.12.min.js and css/jquery.terminal-0.10.12.css
You can also include js/jquery.mousewheel-min.js

```html
<script src="js/jquery.terminal-0.10.12.min.js"></script>
<script src="js/jquery.mousewheel-min.js"></script>
<link href="css/jquery.terminal-0.10.12.css" rel="stylesheet"/>
```
