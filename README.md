...
[![npm](https://img.shields.io/badge/npm-2.6.3-blue.svg)](https://www.npmjs.com/package/jquery.terminal)
![bower](https://img.shields.io/badge/bower-2.6.3-yellow.svg)
[![travis](https://travis-ci.org/jcubic/jquery.terminal.svg?branch=master&f972928eb5b9816749b778d164bb6bc9b63d3cf2)](https://travis-ci.org/jcubic/jquery.terminal)
...
Then include js/jquery.terminal-2.6.3.min.js and css/jquery.terminal-2.6.3.min.css
...
```html
<script src="https://cdn.jsdelivr.net/npm/jquery.terminal@2.6.3/js/jquery.terminal.min.js"></script>
<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/jquery.terminal@2.6.3/css/jquery.terminal.min.css">
```
