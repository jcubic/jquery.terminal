<h1 align="center">
  <img src="https://github.com/jcubic/jquery.terminal/blob/partials-fix/assets/ascii_art.svg?raw=true&ver=2.46.0"
...
[![npm](https://img.shields.io/badge/npm-2.46.0-blue.svg)](https://www.npmjs.com/package/jquery.terminal)
![bower](https://img.shields.io/badge/bower-2.46.0-yellow.svg)
[![Build and test](https://github.com/jcubic/jquery.terminal/actions/workflows/build.yaml/badge.svg?branch=partials-fix&event=push)](https://github.com/jcubic/jquery.terminal/actions/workflows/build.yaml)
[![Coverage Status](https://coveralls.io/repos/github/jcubic/jquery.terminal/badge.svg?branch=partials-fix&0670622677f039243c980ba21d719efe)](https://coveralls.io/github/jcubic/jquery.terminal?branch=partials-fix)
...
* [https://jcubic.github.io/jquery.terminal/?ver=2.46.0](https://jcubic.github.io/jquery.terminal/?ver=2.46.0)
...
Then include js/jquery.terminal-2.46.0.min.js and css/jquery.terminal-2.46.0.min.css
...
```html
<script src="https://cdn.jsdelivr.net/npm/jquery.terminal@2.46.0/js/jquery.terminal.min.js"></script>
<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/jquery.terminal@2.46.0/css/jquery.terminal.min.css"/>
```
...
[![Star History Chart](https://api.star-history.com/svg?repos=jcubic/jquery.terminal&type=Date&branch=partials-fix)](https://star-history.com/#jcubic/jquery.terminal&Date)
