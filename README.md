...
[![npm](https://img.shields.io/badge/npm-2.19.2-blue.svg)](https://www.npmjs.com/package/jquery.terminal)
![bower](https://img.shields.io/badge/bower-2.19.2-yellow.svg)
[![travis](https://travis-ci.org/jcubic/jquery.terminal.svg?branch=master&70d966d922abc5833c69d2e293db4a65403c2149)](https://travis-ci.org/jcubic/jquery.terminal)
...
Then include js/jquery.terminal-2.19.2.min.js and css/jquery.terminal-2.19.2.min.css
...
```html
<script src="https://cdn.jsdelivr.net/npm/jquery.terminal@2.19.2/js/jquery.terminal.min.js"></script>
<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/jquery.terminal@2.19.2/css/jquery.terminal.min.css">
```
