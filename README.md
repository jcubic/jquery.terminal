...
[![npm](https://img.shields.io/badge/npm-1.10.0-blue.svg)](https://www.npmjs.com/package/jquery.terminal)
...
Then include js/jquery.terminal-1.10.0.min.js and css/jquery.terminal-1.10.0.min.css
...
```html
<script src="https://cdn.jsdelivr.net/npm/jquery.terminal@1.10.0/js/jquery.terminal.min.js"></script>
<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/jquery.terminal@1.10.0/css/jquery.terminal.min.css">
```
