...
[![npm](https://img.shields.io/badge/npm-2.32.1-blue.svg)](https://www.npmjs.com/package/jquery.terminal)
![bower](https://img.shields.io/badge/bower-2.32.1-yellow.svg)
...
[![Coverage Status](https://coveralls.io/repos/github/jcubic/jquery.terminal/badge.svg?branch=master&f763f18b51c959746a0b1582a648e83a)](https://coveralls.io/github/jcubic/jquery.terminal?branch=master)
...
* [https://jcubic.github.io/jquery.terminal/?ver=2.32.1](https://jcubic.github.io/jquery.terminal/?ver=2.32.1)
...
Then include js/jquery.terminal-2.32.1.min.js and css/jquery.terminal-2.32.1.min.css
...
```html
<script src="https://cdn.jsdelivr.net/npm/jquery.terminal@2.32.1/js/jquery.terminal.min.js"></script>
<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/jquery.terminal@2.32.1/css/jquery.terminal.min.css">
```
