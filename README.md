...
[![npm](https://img.shields.io/badge/npm-2.5.0-blue.svg)](https://www.npmjs.com/package/jquery.terminal)
![bower](https://img.shields.io/badge/bower-2.5.0-yellow.svg)
[![travis](https://travis-ci.org/jcubic/jquery.terminal.svg?branch=master&54bd02448b9691ab2cdbb7d40eddd7c6d0c52a74)](https://travis-ci.org/jcubic/jquery.terminal)
...
Then include js/jquery.terminal-2.5.0.min.js and css/jquery.terminal-2.5.0.min.css
...
```html
<script src="https://cdn.jsdelivr.net/npm/jquery.terminal@2.5.0/js/jquery.terminal.min.js"></script>
<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/jquery.terminal@2.5.0/css/jquery.terminal.min.css">
```
