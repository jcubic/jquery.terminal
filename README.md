...
[![npm](https://img.shields.io/badge/npm-1.22.4-blue.svg)](https://www.npmjs.com/package/jquery.terminal)
![bower](https://img.shields.io/badge/bower-1.22.4-yellow.svg)
[![travis](https://travis-ci.org/jcubic/jquery.terminal.svg?branch=master&cc9f752564b291f9b75cd31efd2928dd2cdf2ed3)](https://travis-ci.org/jcubic/jquery.terminal)
...
Then include js/jquery.terminal-1.22.4.min.js and css/jquery.terminal-1.22.4.min.css
...
```html
<script src="https://cdn.jsdelivr.net/npm/jquery.terminal@1.22.4/js/jquery.terminal.min.js"></script>
<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/jquery.terminal@1.22.4/css/jquery.terminal.min.css">
```
