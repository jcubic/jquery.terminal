...
Include js/jquery.terminal-0.10.0.min.js and css/jquery.terminal-0.10.0.css
You can also include js/jquery.mousewheel-min.js

```html
<script src="js/jquery.terminal-0.10.0.min.js"></script>
<script src="js/jquery.mousewheel-min.js"></script>
<link href="css/jquery.terminal-0.10.0.css" rel="stylesheet"/>
```
