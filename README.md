...
Include js/jquery.terminal-0.11.2.min.js and css/jquery.terminal-0.11.2.css
You can also include js/jquery.mousewheel-min.js

```html
<script src="js/jquery.terminal-0.11.2.min.js"></script>
<script src="js/jquery.mousewheel-min.js"></script>
<link href="css/jquery.terminal-0.11.2.css" rel="stylesheet"/>
```
...
```html
<script src="https://cdn.jsdelivr.net/jquery.terminal/0.11.2/jquery.terminal.min.js"></script>
<link rel="stylesheet" href="https://cdn.jsdelivr.net/jquery.terminal/0.11.2/jquery.terminal.min.css">
```
