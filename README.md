...
[![npm](https://img.shields.io/badge/npm-1.5.3-blue.svg)](https://www.npmjs.com/package/jquery.terminal)
![bower](https://img.shields.io/badge/bower-1.5.3-yellow.svg)
...
Then include js/jquery.terminal-1.5.3.min.js and css/jquery.terminal-1.5.3.css

```html
<script src="js/jquery.terminal-1.5.3.min.js"></script>
...
```html
<script src="https://cdn.jsdelivr.net/jquery.terminal/1.5.3/jquery.terminal.min.js"></script>
<link rel="stylesheet" href="https://cdn.jsdelivr.net/jquery.terminal/1.5.3/jquery.terminal.min.css">
```
