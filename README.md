...
[![npm](https://img.shields.io/badge/npm-1.22.1-blue.svg)](https://www.npmjs.com/package/jquery.terminal)
![bower](https://img.shields.io/badge/bower-1.22.1-yellow.svg)
[![travis](https://travis-ci.org/jcubic/jquery.terminal.svg?branch=master&423200ffb965938ecbf52907394e764ad0b69cf5)](https://travis-ci.org/jcubic/jquery.terminal)
...
Then include js/jquery.terminal-1.22.1.min.js and css/jquery.terminal-1.22.1.min.css
...
```html
<script src="https://cdn.jsdelivr.net/npm/jquery.terminal@1.22.1/js/jquery.terminal.min.js"></script>
<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/jquery.terminal@1.22.1/css/jquery.terminal.min.css">
```
