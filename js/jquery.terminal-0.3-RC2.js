    ...
    $.fn.cmd = function(options) {
        ...
        var redraw = (function(self) {
                    ...
                    if (position < first_len) {
                        ...
                        if (position <= first_len) {
                            ...
                            if (from_last < last.length) {
                                ...
                                draw_cursor_line(last, last.length-from_last-1);
                            } else {
                                // in the middle
                                if (num_lines == 3) {
                                    console.log('         if');
                                    ...
                                    var pos = (position-first_len-1)%num_chars;
            ...
            return function() {
                ...
                // long line
                var command_len = num_chars - prompt_len - 1;
                if (string.length > command_len) {
                    ...
                    if (position < first_len) {
                        draw_cursor_line(array[0], position);
                        lines_after(array.slice(1));
                    } else if (array.length-1 == position % num_chars) {
                        var num_lines = array.length;
                        var offset = 0;
                        if (position <= first_len) {
                            draw_cursor_line(array[0], position);
