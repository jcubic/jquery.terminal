...
(function() {
    ...
    if (typeof jQuery === 'undefined') {
        get('http://code.jquery.com/jquery-3.5.0.min.js').then(function() {
            jQuery.noConflict();
            get('https://cdnjs.cloudflare.com/ajax/libs/jquery.terminal/2.27.1/css/jquery.terminal.min.css');
            return get('https://cdnjs.cloudflare.com/ajax/libs/jquery.terminal/2.27.1/js/jquery.terminal.min.js');
        }).then(function() {
