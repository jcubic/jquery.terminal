...
i){if(b&&i){a.width(b);a.height(i)}O=h();t.resize(O);var g=C.detach();C.html("");m.each(q,function(p,k){o(k.constructor===Function?k():k)});a.prepend(g);w();return a},echo:function(b){q.push(b);return o(typeof b==="function"?b():b)},error:function(b){a.echo("[[;#f00;]"+b.replace(/\[/g,"&#91;").replace(/\]/g,"&#93;")+"]")},scroll:function(b){var i;if(a.prop){b>a.prop("scrollTop")&&b>0&&a.prop("scrollTop",0);i=a.prop("scrollTop");a.prop("scrollTop",i+b)}else{b>a.attr("scrollTop")&&b>0&&a.attr("scrollTop",
